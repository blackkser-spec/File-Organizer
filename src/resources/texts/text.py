TEXT = {
    ...
    "error": {
        ...
        "gui": {
            ...
            "footer_status_default": "ステータス: ",
            "footer_status_move_complate": "ステータス: 移動完了",
            "footer_status_undo_complete": "ステータス: ファイル移動の巻き戻し完了",
            ...
            "footer_undo_available": "Undo: 利用可能",
            "footer_undo_unavailable": "Undo: 利用不可",
            "cfg_remove_rule": "選択項目を削除",
            "cfg_edit_rule": "選択項目を編集",
            "cfg_reset_config": "設定を初期化",
            "cfg_save_config": "設定を保存",
            "cfg_destination_example": "例: images/jpg",
            "cfg_browse_folder": "フォルダ参照...",
            "cfg_add_rule": "ルール登録",
            "cfg_dialog_reset_confirm": "本当に設定を初期化しますか？\n（保存はまだ行われません）",
            "cfg_close_without_save": "変更が保存されていません。保存しますか？",
        },
}